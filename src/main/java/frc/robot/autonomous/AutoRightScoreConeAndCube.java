...
public class AutoRightScoreConeAndCube extends AutoBase {
    ...
    public AutoRightScoreConeAndCube(
        ...
        var startPosition_in = autoRightScoreConeAndPickCommand.getStartPosition_in();
