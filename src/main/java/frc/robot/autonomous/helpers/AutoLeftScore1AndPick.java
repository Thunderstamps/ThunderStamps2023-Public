...
public class AutoLeftScore1AndPick extends AutoBase {

    private static final double manualOffsetY_in = 0.0; // was -6.0 at Western

    private static final double startX_in = 56.0;
    private static final double startY_in = 173.0;
